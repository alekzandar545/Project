...
void Event::MonsterEvent() {
    ...
    BattleUI battle(map->GetPlayer(), monster);
...
void Event::NextFloor() {
    system("cls");
    *map = Map(Fib(Constants::STARTING_WIDTH[0], Constants::STARTING_WIDTH[1], map->GetFloor()),
               ...
               Fib(Constants::STARTING_TREASURE[0], Constants::STARTING_TREASURE[1], map->GetFloor()), 
